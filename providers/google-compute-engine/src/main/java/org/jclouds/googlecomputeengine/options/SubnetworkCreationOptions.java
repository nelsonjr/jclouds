...
public abstract class SubnetworkCreationOptions {
   ...
   public static SubnetworkCreationOptions create(String name, String description, String rangeIPv4,
                                                  String gatewayIPv4) {
      return new AutoValue_SubnetworkCreationOptions(name, description, rangeIPv4, gatewayIPv4);
   }
   ...
   public static class Builder {
      ...
      public SubnetworkCreationOptions build() {
